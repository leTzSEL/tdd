...
public class AccountManager {
    ...
    public void moneyTransferToAnotherAccount(Account accountSenMoney, Account accountRecived, int moneyTransferred) {
        if (cantTransferNegativeAndMax1500(moneyTransferred)) {
            accountSenMoney.withdrawnMoneyFromAccount(moneyTransferred);
        }
